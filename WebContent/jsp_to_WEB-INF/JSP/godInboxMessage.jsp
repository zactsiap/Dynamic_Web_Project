		...
		<div class="col-sm-12">
			<div class="row">
				...
				<div class="col-md-9">
					<br>
					<div class="col-sm-11">
						<h5 class="text-center">God Inbox</h5>
					</div>
					<div class="col-sm-11">
						...
						<div id="messages">
							...
							<table>
								...
								<tr>
									...
									<td class='clickable-row' data-href='godReadMessage.jsp'>Alexander
										Pierce</td>
									<td class='clickable-row' data-href='godReadMessage.jsp'>John
										Doe</td>
									<td class='clickable-row' data-href='godReadMessage.jsp'>Trying
										to find a solution to this problem...</td>
									<td class='clickable-row' data-href='godReadMessage.jsp'>5
										mins ago</td>
								</tr>
							</table>
						</div>
